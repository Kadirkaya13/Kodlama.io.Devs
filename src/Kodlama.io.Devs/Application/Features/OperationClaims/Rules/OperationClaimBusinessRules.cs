...
namespace Application.Features.OperationClaims.Rules
{
    public class OperationClaimBusinessRules
    {
        ...
        public void OperationClaimShouldExistsWhenRequested(OperationClaim operationClaim)
        {
            if (operationClaim == null) throw new BusinessException(Messages.objectNotExists);
        }
    }
}
